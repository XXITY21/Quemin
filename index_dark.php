...
<header>
            ...
            <div class="list-services">
                <div class="service-item">
                    <div class="service-item__wrapper">
                        ...
                        <a class="Book_intro list-services__book" href="">Забронировать</a>
                    </div>
                </div>
                <div class="service-item">
                    <div class="service-item__wrapper">
    ...
    <div class="mainscreen">    
              <form action="action">
                <p>Ф.И.О.</p>
                <input type="text" class="inputbox" name="name" placeholder="Иванов Иван Иванович" required />
                <p>Номер телефона</p>
                <input type="tel" class="inputbox" name="tel" placeholder="+79101710000"  required />
                <p>Электронная почта</p>
                <input type="email" class="inputbox" name="email" placeholder="ivanov@mpt.ru"  required />
                <p>Студия</p>
                ...
                <input type="checkbox" class="check" checked="checked" name="sameadr"> Я прочитал(а) правила фотостудии 
